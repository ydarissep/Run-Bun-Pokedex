const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
    ...
    [SPECIES_GRIMER]                = {{EVO_LEVEL, 36, SPECIES_MUK},
                                       {EVO_ITEM, ITEM_DUSK_STONE, SPECIES_MUK_ALOLAN}},
    ...
    [SPECIES_DROWZEE]               = {{EVO_LEVEL, 24, SPECIES_HYPNO}},
    ...
    [SPECIES_EXEGGCUTE]             = {{EVO_ITEM, ITEM_LEAF_STONE, SPECIES_EXEGGUTOR},
                                       {EVO_ITEM, ITEM_SHINY_STONE, SPECIES_EXEGGUTOR_ALOLAN}},
    ...
    [SPECIES_SCYTHER]               = {{EVO_ITEM, ITEM_METAL_COAT, SPECIES_SCIZOR},
                                       {EVO_ITEM, ITEM_PROTECTOR, SPECIES_KLEAVOR}},
#if P_GEN_4_POKEMON == TRUE
    ...
    [SPECIES_QUILAVA]               = {{EVO_MAPSEC, MAPSEC_MT_PYRE, SPECIES_TYPHLOSION_HISUIAN},
    ...
    [SPECIES_URSARING]              = {{EVO_ITEM, ITEM_HONEY, SPECIES_URSALUNA}},
...
#endif
    [SPECIES_STANTLER]              = {{EVO_LEVEL, 34, SPECIES_WYRDEER}},
    ...
    [SPECIES_SEALEO]                = {{EVO_LEVEL, 34, SPECIES_WALREIN}},
    [SPECIES_CACNEA]                = {{EVO_LEVEL, 32, SPECIES_CACTURNE}},
    [SPECIES_SNORUNT]               = {{EVO_LEVEL, 25, SPECIES_GLALIE},
                                    #if P_GEN_4_POKEMON == TRUE
    ...
    [SPECIES_MEDITITE]              = {{EVO_LEVEL, 34, SPECIES_MEDICHAM}},
    ...
    [SPECIES_ARON]                  = {{EVO_LEVEL, 26, SPECIES_LAIRON}},
    ...
    [SPECIES_RIOLU]                 = {{EVO_LEVEL, 28, SPECIES_LUCARIO}},
    ...
    [SPECIES_FINNEON]               = {{EVO_LEVEL, 20, SPECIES_LUMINEON}},
    [SPECIES_MANTYKE]               = {{EVO_SPECIFIC_MON_IN_PARTY, SPECIES_REMORAID, SPECIES_MANTINE}},
    [SPECIES_SNOVER]                = {{EVO_LEVEL, 36, SPECIES_ABOMASNOW}},
    ...
    [SPECIES_BASCULIN]              = {{EVO_MAPSEC, MAPSEC_ABANDONED_SHIP, SPECIES_BASCULEGION}},
    [SPECIES_BASCULIN_BLUE_STRIPED] = {{EVO_MAPSEC, MAPSEC_ABANDONED_SHIP, SPECIES_BASCULEGION}},
    [SPECIES_SANDILE]               = {{EVO_LEVEL, 22, SPECIES_KROKOROK}},
    [SPECIES_KROKOROK]              = {{EVO_LEVEL, 36, SPECIES_KROOKODILE}},
    ...
    [SPECIES_DEERLING]              = {{EVO_LEVEL, 30, SPECIES_SAWSBUCK}},
    ...
    [SPECIES_AMAURA]                = {{EVO_LEVEL, 34, SPECIES_AURORUS}},
    ...
    [SPECIES_BERGMITE]              = {{EVO_MOVE, MOVE_ANCIENT_POWER, SPECIES_AVALUGG_HISUIAN},
                                       {EVO_ITEM, ITEM_ICE_STONE, SPECIES_AVALUGG}},
    ...
    [SPECIES_DARTRIX]               = {{EVO_LEVEL_SILCOON, 34, SPECIES_DECIDUEYE},
    ...
    [SPECIES_SALANDIT]              = {{EVO_LEVEL, 30, SPECIES_SALAZZLE}},
    [SPECIES_STUFFUL]               = {{EVO_LEVEL, 26, SPECIES_BEWEAR}},
    [SPECIES_BOUNSWEET]             = {{EVO_LEVEL, 12, SPECIES_STEENEE}},
    ...
    [SPECIES_CORVISQUIRE]           = {{EVO_LEVEL, 44, SPECIES_CORVIKNIGHT}},
    ...
    [SPECIES_YAMPER]                = {{EVO_LEVEL, 22, SPECIES_BOLTUND}},
    ...
    [SPECIES_SIZZLIPEDE]            = {{EVO_LEVEL, 25, SPECIES_CENTISKORCH}},
    ...
    [SPECIES_KUBFU]                 = {{EVO_LEVEL_SILCOON, 50, SPECIES_URSHIFU},
    ...
    [SPECIES_GRAVELER_ALOLAN]       = {{EVO_LEVEL, 38, SPECIES_GOLEM_ALOLAN}},
    [SPECIES_GRIMER_ALOLAN]         = {{EVO_LEVEL, 38, SPECIES_MUK_ALOLAN}},
#if P_GEN_8_POKEMON == TRUE
    [SPECIES_MEOWTH_GALARIAN]       = {{EVO_LEVEL, 26, SPECIES_PERRSERKER}},
#endif
    ...
    [SPECIES_QWILFISH_HISUIAN]      = {{EVO_MOVE, MOVE_EXPLOSION, SPECIES_OVERQWIL}},
...
#endif
#if P_GEN_5_POKEMON == TRUE
    [SPECIES_DEERLING_SUMMER]       = {{EVO_LEVEL, 30, SPECIES_SAWSBUCK_SUMMER}},
    [SPECIES_DEERLING_AUTUMN]       = {{EVO_LEVEL, 30, SPECIES_SAWSBUCK_AUTUMN}},
    [SPECIES_DEERLING_WINTER]       = {{EVO_LEVEL, 30, SPECIES_SAWSBUCK_WINTER}},
#endif
#if P_GEN_6_POKEMON == TRUE
