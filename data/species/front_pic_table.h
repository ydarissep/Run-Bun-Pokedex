...
#if P_GEN_5_POKEMON == TRUE
    SPECIES_SPRITE(SAMUROTT_HISUIAN, gMonFrontPic_SamurottHisuian), //gMonFrontPic_SamurottHisuian),
...
#endif
#if P_GEN_7_POKEMON == TRUE
    SPECIES_SPRITE(DECIDUEYE_HISUIAN, gMonFrontPic_DecidueyeHisuian), //gMonFrontPic_DecidueyeHisuian),
#endif
