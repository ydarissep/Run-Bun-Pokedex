async function getMoves(Moves){
    ...
    const rawMoves = await fetch(`https://raw.githubusercontent.com/${repo}/data/moves/battle_moves.h`)
...
async function getMovesDescription(Moves){
    ...
    const rawMovesDescription = await fetch(`https://raw.githubusercontent.com/${repo}/data/moves/move_descriptions.h`)
