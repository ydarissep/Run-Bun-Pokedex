async function getWildLocations(locations){
    ...
    const rawWildLocations = await fetch(`https://raw.githubusercontent.com/${repo}/locations/wild_encounters.json`)
...
async function getGameCornerLocations(locations){
    ...
    const rawGameCornerLocations = await fetch(`https://raw.githubusercontent.com/${repo}/locations/scripts.inc`)
